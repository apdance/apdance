<?php
die('Designiado apenas para desenvolvimento.');
/**
 ...
 * -------------------------------------------------------------------Messi Properties
 * @property Util                $util                                Classe auxiliar - Funções para facilitar o desenvolvimento.
 * @property Curl                $curl
 * @property ApiModel            $apimodel
 * @property WSFWCardPOS         $wsfwcardpos
 * @property Produtos_operadoraModel        $Produtos_operadoraModel
 * @property  RecargaRv         $recargarv
 */
class CI_Controller {
 ...
 * -------------------------------------------------------------------Messi Properties
 * @property Util                           $util                     Classe auxiliar - Funções para facilitar o desenvolvimento.
 * @property operadoramodel      $operadoramodel
 *
 */
class CI_Model {
